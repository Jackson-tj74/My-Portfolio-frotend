...
import { Code2, Monitor, BarChart3, ShieldCheck, ChevronRight, X } from "lucide-react";
...
const services = [
    ...
    },
    {
      ...
      shortDesc: "I research keywords & do on-page SEO to drive traffic.",
      longDesc: `I help your website rank on the first pages of Google. This drives organic traffic to your business, helping you reach more customers without constantly relying on paid advertisements.`,
      Icon: BarChart3,
    },
    {
      title: "Security Expert",
      shortDesc: "Monitor and protect your digital assets from threats.",
      longDesc: `Reflecting the attention to detail seen in your GitHub contributions, I provide deep code audits and monitoring to ensure there are no security vulnerabilities in your applications.`,
      Icon: ShieldCheck,
    }
  ];
